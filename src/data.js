...
export default [
  ...
  },
  {
    ...
    detailedDescription: 'Plateforme de mise en relation entre associations et développeurs, l\'objectif est que les associations puissent partager leur besoin de création de sites/applications et demander de l\'aide auprès de développeurs bénévoles, qui eux, pourrait être à la recherche d’une première expérience, de participer à un projet de groupe, ou encore, de tout simplement participer à un projet qui a du sens.',
    process: 'Ce projet à été réalisé dans une dynamique agile, par 4 développeurs fullstack puis poursuivi de mon côté. Dans une première phase de préparation (cahier des charges), nous avons travaillé sur la définition de notre MVP, les besoins et objectifs du projet, notre arborescence, architecture mise en place, diagrammes entité-relation/séquence/données/use-case, création de wireframe et maquettes. Est venu ensuite une phase de conception, puis de débuggage, pour finir sur une présentation de l\'app.',
  ...
  },
  {
    ...
    detailedDescription: 'Plateforme permettant d\'organiser son temps, un petit peu à la manière d\'un Trello. L\'objectif était de proposer une interface personnalisable et épurée, afin de permettre une facilité de prise en main pour tous et pour tout type de projet. Dès l\'écran d\'accueil, l\'utilisateur a la possibilité de voir ses tâches du jour, ses 5 tâches les plus proches à venir et d\'avoir un oeil sur ses projets.',
    process: 'Ce projet a été réalisé en agilitée, par 5 développeurs (3 React et 2 Symfony). Dans une première phase de préparation (cahier des charges), nous avons travaillé sur la définition de notre MVP, les besoins et objectifs du projet, notre arborescence, architecture mise en place, définition de la BDD, création de wireframe et maquettes ; est venu ensuite une phase de conception, puis de débuggage, pour finir sur une présentation de l\'app.',
